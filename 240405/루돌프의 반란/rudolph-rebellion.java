...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i=1;i<=P;i++){
            ...
            Santa s = new Santa(r,c,getdistance(r,c,dolfr,dolfc),0,id);
        ...
        for(int i=1;i<=P;i++){
            ...
            for(int[] temp:dir){
                ...
                if(x==dolfr&&y == dolfc){
                    ...
                    pushed(s,dolfr+revx*D,dolfc+revy*D,revx,revy);//밀릴산타, 밀릴 위치 , 밀릴 방향
                    continue loop;
                }
    ...
    public static void dolfmove(){
        ...
        for(Santa ss:arrlst){
            ss.d = getdistance(ss.r,ss.c,dolfr,dolfc);
        }
